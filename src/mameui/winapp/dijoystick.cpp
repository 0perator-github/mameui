...
//	===========================================================================
//	dijoystick.cpp - DirectInput joystick support
//	===========================================================================
...
static int DIJoystick_is_joy_pressed(int joycode)
{
	...
	if (joy_stick == JOYCODE_STICK_POV)
	{
		...
		int axis_value = (GET_JOYCODE_BUTTON(joycode) % 2 == 0) ?
			128 + static_cast<int>(127 * cos(2 * std::numbers::pi * angle / 360.0)) :  // x-axis
			128 + static_cast<int>(127 * sin(2 * std::numbers::pi * angle / 360.0));   // y-axis
