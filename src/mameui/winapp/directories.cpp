...
//	-------------------------------------------------------
//	Directories_OnDelete - handles the Delete button click for the Directories
//	dialog box
//	Parameters:
//		hDlg - handle to the dialog box
//	-------------------------------------------------------
...
//	-------------------------------------------------------
//	Directories_OnBeginLabelEdit - handles the LVN_BEGINLABELEDIT notification for
//	the list view in the Directories
//	Parameters:
//		hDlg - handle to the dialog box
//		pNMHDR - pointer to the NMHDR structure that contains the notification
...
//	-------------------------------------------------------
//	SetDirectoryEntry - sets the directory entry in the data structure and
...
//	-------------------------------------------------------
//	Directories_OnEndLabelEdit - handles the LVN_ENDLABELEDIT notification for
//	the list view in the Directories
//	Parameters:
//		hDlg - handle to the dialog box
//		pNMHDR - pointer to the NMHDR structure that contains the notification
...
//	-------------------------------------------------------
//	Directories_OnCommand - handles the WM_COMMAND message for the Directories
//	dialog box
//	Parameters:
//		hDlg - handle to the dialog box
...
//	-------------------------------------------------------
//	Directories_OnNotify - handles the WM_NOTIFY message for the Directories
//	dialog box
//	Parameters:
//		hDlg - handle to the dialog box
//		id - identifier of the control that sent the message
...
//	-------------------------------------------------------
//	BrowseCallbackProc - callback function for the SHBrowseForFolder dialog
//	Parameters:
...
//		initial_dirpath - initial directory path to display in the dialog box
//		selected_dirpath - output parameter to receive the selected directory path
//	-------------------------------------------------------
