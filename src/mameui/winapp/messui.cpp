...
static std::wstring SoftwareTabView_GetTabShortName(int tab_index);
static std::wstring SoftwareTabView_GetTabLongName(int tab_index);
...
static std::wstring SoftwareTabView_GetTabShortName(int tab_index)
{
	...
	return std::wstring(soft_tabnames[tab_index].short_name);
}
...
{
	assert(tab_index >= 0 && tab_index < std::size(soft_tabnames));
	return std::wstring(soft_tabnames[tab_index].long_name);
}
