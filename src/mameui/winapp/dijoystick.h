...
extern const struct osd_joystick_t DIJoystick;

extern int    DIJoystick_GetNumPhysicalJoysticks(void);
extern wchar_t *DIJoystick_GetPhysicalJoystickName(int num_joystick);

extern int    DIJoystick_GetNumPhysicalJoystickAxes(int num_joystick);
extern wchar_t *DIJoystick_GetPhysicalJoystickAxisName(int num_joystick, int num_axis);
