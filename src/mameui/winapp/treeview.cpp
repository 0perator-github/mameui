...
LPEXFOLDERDATA NewExtraFolderData(std::string title, int folderId, int parentId, int iconId, int subIconId, DWORD dwFlags)
{
	...
	lpExtraFolderData->m_szTitle = title;
...
//	std::cout << "Trying to load " << ICON_MAX << " normal icons" << std::endl;
...
//	std::cout << "Trying to load " << numExtraIcons << " extra custom-folder icons" << std::endl;
