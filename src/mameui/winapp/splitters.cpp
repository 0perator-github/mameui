...
//	===========================================================================
//	splitters.cpp - Splitter bar support
//	===========================================================================
...
void AdjustSplitter2Rect(HWND hWnd, LPRECT lpRect)
{
	...
	lpRect->right = std::min(lpRect->right - GetMinimumScreenShotWindowWidth(), lpRect->right);

	lpRect->left = std::max(lpRect->left, (pRect.right - (pRect.right - pRect.left)) / 2);
}
