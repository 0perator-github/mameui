...
using SOFTWARETYPE_OPTIONS = enum softwaretype_options : std::uint64_t
{
	SOFTWARETYPE_UNSET = std::numeric_limits<std::uint64_t>::max(),
	// Global types
...
using DIRPATH_OPTIONS = enum dirpath_options : std::size_t
{
	DIRPATH_UNSET = std::numeric_limits<std::size_t>::max(),
	DIRPATH_PLUGINDATAPATH = 0,
	DIRPATH_MEDIAPATH,
	DIRPATH_HASHPATH,
	DIRPATH_SAMPLEPATH,
	DIRPATH_ARTPATH,
