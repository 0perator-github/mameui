...
struct datamap_entry
{
	...
	int dlgitem = 0;
	datamap_entry_type type = datamap_entry_type::DM_NONE;
	std::string option_name;

	// callbacks
	datamap_callback callbacks[datamap_callback_type::DCT_COUNT]{};
	get_option_name_callback get_option_name = nullptr;
	...
	// trackbar options
	bool use_trackbar_options = false;
	float trackbar_min = 0.0f;
	float trackbar_max = 0.0f;
	float trackbar_increments = 0.0f;
};
...
//	-------------------------------------------------------
//	datamap_create - create a new datamap
//	Parameters:
//		None
//	Returns:
//		Pointer to the new datamap, or nullptr if allocation failed
//	-------------------------------------------------------
...
//	-------------------------------------------------------
//	datamap_free - free a datamap
//	Parameters:
//		map - pointer to the datamap to free
//	-------------------------------------------------------
...
//	-------------------------------------------------------
//	datamap_add - add a new entry to the datamap
//	Parameters:
//		map - pointer to the datamap to add the entry to
//		dlgitem - the dialog item ID of the control to map
//		type - the type of the entry (DM_BOOL, DM_INT, DM_FLOAT, DM_STRING)
//		option_name - the name of the option to map to the control
//	-------------------------------------------------------
...
//	-------------------------------------------------------
//	datamap_set_callback - set a callback for a datamap entry
//	Parameters:
//		map - pointer to the datamap
//		dlgitem - the dialog item ID of the control to set the callback for
//		datamap_callback_type callback_type - the type of callback to
//		set (DCT_READ_CONTROL, DCT_POPULATE_CONTROL, DCT_UPDATE_STATUS)
//		datamap_callback callback - the callback function to set
//	-------------------------------------------------------

void datamap_set_callback(datamap* map, int dlgitem, datamap_callback_type callback_type, datamap_callback callback)
{
	if (callback_type < 0 || callback_type >= DCT_COUNT)
	{
		std::cout << "Datamap.cpp line __LINE__ invalid callback type" << "\n";
		throw std::invalid_argument("Invalid callback type");
	}
...
//	-------------------------------------------------------
//	datamap_set_option_name_callback - set a callback for a datamap entry to
//	get the option name
//	Parameters:
// 		map - pointer to the datamap
// 		dlgitem - the dialog item ID of the control to set the callback for
// 		get_option_name - the callback function to get the option name
//	-------------------------------------------------------
...
//	-------------------------------------------------------
//	datamap_set_trackbar_range - set the range for a trackbar control
//	Parameters:
//		map - pointer to the datamap
//		dlgitem - the dialog item ID of the trackbar control
//		min - the minimum value of the trackbar
//		max - the maximum value of the trackbar
//		increments - the increment value of the trackbar
//	-------------------------------------------------------
...
//	-------------------------------------------------------
//	datamap_set_int_format - set the format for an int control
//	Parameters:
//		map - pointer to the datamap
//		dlgitem - the dialog item ID of the control to set the format for
//		format - the format string to use for the control
//	-------------------------------------------------------
...
//	-------------------------------------------------------
//	datamap_set_float_format - set the format for a float control
//	Parameters:
//		map - pointer to the datamap
//		dlgitem - the dialog item ID of the control to set the format for
//		format - the format string to use for the control
...
//	-------------------------------------------------------
//	datamap_read_control - read the value from a control and update the corresponding option
//	Parameters:
//		map - pointer to the datamap
// 		dialog - the dialog window handle
// 		o - the windows_options object
// 		dlgitem - the dialog item ID of the control to read
//	Returns:
...
//	-------------------------------------------------------
//  datamap_read_all_controls - read the values from all controls and update the corresponding options
//	Parameters:
// 		map - pointer to the datamap
// 		dialog - the dialog window handle
// 		o - the windows_options object
...
//	-------------------------------------------------------
//	datamap_populate_control - populate a control with the value from the
//	corresponding option
//	Parameters:
//		map - pointer to the datamap
//		dialog - the dialog window handle
//		o - the windows_options object
//		dlgitem - the dialog item ID of the control to populate
//	-------------------------------------------------------
...
//	-------------------------------------------------------
//	datamap_populate_all_controls - populate all controls with the values from
...
//	-------------------------------------------------------
//	datamap_update_control - update the status of a control based on the
//	corresponding option
//	Parameters:
//		map - pointer to the datamap
//		dialog - the dialog window handle
//		o - the windows_options object
//		dlgitem - the dialog item ID of the control to update
//	-------------------------------------------------------
...
//	-------------------------------------------------------
//  datamap_update_all_controls - update the status of all controls based on
//	the corresponding options
//	Parameters:
//		map - pointer to the datamap
//		dialog - the dialog window handle
...
//	-------------------------------------------------------
//	find_entry - find a datamap entry by dialog item ID
//	Parameters:
//		map - pointer to the datamap
//		dlgitem - the dialog item ID
//	Returns:
//		Pointer to the datamap entry, or nullptr if not found
//	-------------------------------------------------------
...
//	-------------------------------------------------------
//	get_control_type - get the control type of a dialog item
//	Parameters:
//		hwnd - the dialog item window handle
//	Returns:
//		The control type of the dialog item
//	-------------------------------------------------------	
...
//	-------------------------------------------------------
//	is_control_displayonly - check if a control is display-only
//	(static text or read-only edit)
//	Parameters:
// 		hwnd - the dialog item window handle
// 	Returns:
// 		true if the control is display-only, false otherwise
//	-------------------------------------------------------
...
//	-------------------------------------------------------
//	broadcast_changes - broadcast changes to other controls that share the
//	same option name
//	Parameters:
// 	map - pointer to the datamap
// 	dialog - the dialog window handle
...
//	-------------------------------------------------------
//	control_operation - perform an operation on a control
//	(read, populate, update)
//	Parameters:
//		map - pointer to the datamap
//		dialog - the dialog window handle
//		o - the windows_options object
//		entry - the datamap entry
//		callback_type - the type of callback to perform
//	Returns:
//		1 if the value was changed, 0 otherwise
//	-------------------------------------------------------
...
//	-------------------------------------------------------
//	trackbar_value_from_position - convert a trackbar position to a value
//	Parameters:
// 		entry - pointer to the datamap entry
...
//	-------------------------------------------------------
//	trackbar_position_from_value - convert a value to a trackbar position
//	Parameters:
// 		entry - pointer to the datamap entry
// 		value - the value to convert
// 	Returns:
// 		the corresponding trackbar position
//	-------------------------------------------------------
...
//	-------------------------------------------------------
//	read_control - read the value from a control and update the
//	corresponding option
//	Parameters:
//		map - pointer to the datamap
//		hwnd - the dialog item window handle
