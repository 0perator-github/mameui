...
// ============================================================================
// dialogs.cpp - Dialog box procedures go here
// ============================================================================
...
constexpr std::size_t NUM_EXCLUSIONS = 12;
constexpr std::size_t NUMHISTORYTAB = std::size(g_ComboBoxHistoryTab);
...
static HTREEITEM InsertCustomFolder(HWND tree_view_handle, HTREEITEM parent_handle, LPTREEFOLDER folder,bool has_selection)
{
...
static HTREEITEM InsertChildCustomFolders(HWND tree_view_handle, LPTREEFOLDER default_selection, HTREEITEM parent_handle, std::size_t parent_index)
{
...
static HTREEITEM InsertCustomFolders(HWND tree_view_handle, LPTREEFOLDER default_selection)
{
	std::size_t num_folders = 0;
