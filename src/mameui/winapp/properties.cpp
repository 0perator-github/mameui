	...
	else
	{
		...
		else
		{
			for (screen_device &screen : screen_device_enumerator(config.root_device()))
			{
				...
				if (extract_bit(GetDriverCacheLower(nIndex), 2)) //ORIENTATION_SWAP_XY
				{
