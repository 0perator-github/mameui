...
{
	emu_set_value(options, OPTION_MEDIAPATH, dir_get_value(DIRMAP_MEDIAPATH));
	emu_set_value(options, OPTION_SAMPLEPATH, dir_get_value(DIRMAP_SAMPLEPATH));
	emu_set_value(options, OPTION_INIPATH, dir_get_value(DIRMAP_INIPATH));
	emu_set_value(options, OPTION_CFG_DIRECTORY, dir_get_value(DIRMAP_CFG_DIRECTORY));
	emu_set_value(options, OPTION_SNAPSHOT_DIRECTORY, dir_get_value(DIRMAP_SNAPSHOT_DIRECTORY));
	emu_set_value(options, OPTION_INPUT_DIRECTORY, dir_get_value(DIRMAP_INPUT_DIRECTORY));
	emu_set_value(options, OPTION_STATE_DIRECTORY, dir_get_value(DIRMAP_STATE_DIRECTORY));
	emu_set_value(options, OPTION_ARTPATH, dir_get_value(DIRMAP_ARTPATH));
	emu_set_value(options, OPTION_NVRAM_DIRECTORY, dir_get_value(DIRMAP_NVRAM_DIRECTORY));
	emu_set_value(options, OPTION_CTRLRPATH, dir_get_value(DIRMAP_CTRLRPATH));
	emu_set_value(options, OPTION_CHEATPATH, dir_get_value(DIRMAP_CHEATPATH));
	emu_set_value(options, OPTION_CROSSHAIRPATH, dir_get_value(DIRMAP_CROSSHAIRPATH));
	emu_set_value(options, OPTION_FONTPATH, dir_get_value(DIRMAP_FONTPATH));
	emu_set_value(options, OPTION_DIFF_DIRECTORY, dir_get_value(DIRMAP_DIFF_DIRECTORY));
	emu_set_value(options, OPTION_SNAPNAME, emu_get_value(emu_global, OPTION_SNAPNAME));
	emu_set_value(options, OPTION_DEBUG, "0");
	emu_set_value(options, OPTION_SPEAKER_REPORT, "0");
