...
#include "libjpeg/jpeglib.h" // 3rdparty lib
...
namespace
{
	...
	***************************************************************************/
	...
	bool LoadDIB(std::string_view full_name, HGLOBAL* phDIB, HPALETTE* pPal, int pic_type)
	{
		...
		{
		case TAB_ARTWORK:
			directory_paths = dir_get_value(DIRMAP_ARTPREV_PATH);
			directory_name = "artpreview";
			break;
		case TAB_BOSSES:
			directory_paths = dir_get_value(DIRMAP_BOSSES_PATH);
			directory_name = "bosses";
			break;
		case TAB_CABINET:
			directory_paths = dir_get_value(DIRMAP_CABINETS_PATH);
			directory_name = "cabinets";
			break;
		case TAB_CONTROL_PANEL:
			directory_paths = dir_get_value(DIRMAP_CPANELS_PATH);
			directory_name = "cpanel";
			break;
		case TAB_COVER:
			directory_paths = dir_get_value(DIRMAP_COVER_PATH);
			directory_name = "covers";
			break;
		case TAB_ENDS:
			directory_paths = dir_get_value(DIRMAP_ENDS_PATH);
			directory_name = "ends";
			break;
		case TAB_FLYER:
			directory_paths = dir_get_value(DIRMAP_FLYERS_PATH);
			directory_name = "flyers";
			break;
		case TAB_GAMEOVER:
			directory_paths = dir_get_value(DIRMAP_GAMEOVER_PATH);
			directory_name = "gameover";
			break;
		case TAB_HOWTO:
			directory_paths = dir_get_value(DIRMAP_HOWTO_PATH);
			directory_name = "howto";
			break;
		case TAB_LOGO:
			directory_paths = dir_get_value(DIRMAP_LOGOS_PATH);
			directory_name = "logo";
			break;
		case TAB_MARQUEE:
			directory_paths = dir_get_value(DIRMAP_MARQUEES_PATH);
			directory_name = "marquees";
			break;
		case TAB_PCB:
			directory_paths = dir_get_value(DIRMAP_PCBS_PATH);
			directory_name = "pcb";
			break;
		case TAB_SCORES:
			directory_paths = dir_get_value(DIRMAP_SCORES_PATH);
			directory_name = "scores";
			break;
		case TAB_SCREENSHOT:
			directory_paths = dir_get_value(DIRMAP_SNAPSHOT_DIRECTORY);
			directory_name = "snap";
			break;
		case TAB_SELECT:
			directory_paths = dir_get_value(DIRMAP_SELECT_PATH);
			directory_name = "select";
			break;
		case TAB_TITLE:
			directory_paths = dir_get_value(DIRMAP_TITLES_PATH);
			directory_name = "titles";
			break;
		case TAB_VERSUS:
			directory_paths = dir_get_value(DIRMAP_VERSUS_PATH);
