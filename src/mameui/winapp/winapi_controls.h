...
#ifndef MAMEUI_WINAPP_WINAPI_CONTROLS_H
#define MAMEUI_WINAPP_WINAPI_CONTROLS_H
...
namespace mameui::winapi
{
	namespace controls
	{
		...
		namespace list_view
		{
			void create_drag_image(HWND window_handle, int index, LPPOINT upper_left);
...
#endif // MAMEUI_WINAPP_WINAPI_CONTROLS_H
