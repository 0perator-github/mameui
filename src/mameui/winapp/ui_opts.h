...
//		std::cout << string_util::pad_to_center("START DUMP OF DEFAULT", pad_length, true) << std::endl;

//		for (auto const &it : m_list)
//			std::cout << it.first << " = " << it.second << std::endl;

//		std::cout << string_util::pad_to_center("END DUMP OF DEFAULT", pad_length, true) << std::endl;
	}
	...
	{
		std::string option_value = getter(option_name);
