...
// --------------------------------------------------------
// mui_strchr - finds the first occurrence of a character or substring in a
// string
// parameters:
...
// --------------------------------------------------------
// mui_strnicmp - compares two character strings up to a specified count,
// case-insensitively
// parameters:
// std::string_view s1 - first string to compare
// std::string_view s2 - second string to compare
...
// --------------------------------------------------------
// mui_strnlen - calculates the length of a character string up to a specified
// maximum count
// parameters:
