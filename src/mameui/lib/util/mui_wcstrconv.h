...
[[nodisard]] std::string mui_utf8_from_utf16string(std::wstring_view utf16string, int wchar_count = -1);
...
[[nodisard]] std::wstring mui_utf16_from_utf8string(std::string_view utf8string, int byte_count = -1);
