...
// --------------------------------------------------------
// mui_tcsncpy - copies a TCHAR string from src to dst, up to a
// specified count
// parameters:
// TCHAR *dst - the destination string
// const TCHAR *src - the source string
...
// --------------------------------------------------------
// mui_tcsncpy - copies a TCHAR string from src to a new allocated string,
...
// --------------------------------------------------------
// mui_tcsncmp - compares two TCHAR strings up to a specified number
// of characters
// parameters:
// tstring_view s1 - the first string to compare
// tstring_view s2 - the second string to compare
