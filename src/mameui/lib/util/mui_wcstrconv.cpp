...
int mui_utf8_from_utf16string(std::string &utf8string, std::wstring_view utf16string, int wchar_count)
{
...
std::string mui_utf8_from_utf16string(std::wstring_view utf16string, int wchar_count)
{
...
int mui_utf8_from_utf16cstring(char *utf8cstring, int byte_count, const wchar_t *utf16cstring, int wchar_count)
{
...
int mui_utf8_from_utf16cstring(char *utf8cstring, const wchar_t *utf16cstring, int wchar_count)
{
	if (!utf16cstring || *utf16cstring == L'\0' || wchar_count == 0)
		return 0;
...
char *mui_utf8_from_utf16cstring(const wchar_t *utf16cstring, int wchar_count)
{
	if (!utf16cstring || *utf16cstring == L'\0' || wchar_count == 0)
		return nullptr;
...
int mui_utf16_from_utf8string(std::wstring &utf16string, std::string_view utf8string, int byte_count)
{
...
std::wstring mui_utf16_from_utf8string(std::string_view utf8string, int byte_count)
{
...
int mui_utf16_from_utf8cstring(wchar_t* utf16cstring, int wchar_count, const char* utf8cstring, int byte_count)
{
...
int mui_utf16_from_utf8cstring(wchar_t *utf16cstring, const char *utf8cstring, int byte_count)
{
	if (!utf8cstring || *utf8cstring == '\0' || byte_count == 0)
		return 0;
...
wchar_t *mui_utf16_from_utf8cstring(const char *utf8cstring, int byte_count)
{
	if (!utf8cstring || *utf8cstring == '\0' || byte_count == 0)
		return nullptr;
