...
//	===========================================================================
//	mui_wcstrconv.cpp - C++ functions for Wide character C string conversion
//	===========================================================================
...
//	-------------------------------------------------------
//	mui_utf8_from_utf16string - convert UTF-16 string to UTF-8 string
//	Parameters:
//	std::string &utf8string - reference to the output UTF-8 string
//	std::wstring_view utf16string - input UTF-16 string view
//	int wchar_count - number of wide characters to convert
//	-------------------------------------------------------
...
//	-------------------------------------------------------
//	mui_utf8_from_utf16cstring - convert UTF-16 C string to UTF-8 C string
//	Parameters:
//	char *utf8cstring - pointer to the output UTF-8 C string
//	int byte_count - size of the output buffer in bytes
//	const wchar_t *utf16cstring - pointer to the input UTF-16 C string
//	int wchar_count - number of wide characters to convert
//	-------------------------------------------------------
...
//	-------------------------------------------------------
//	mui_utf16_from_utf8string - convert UTF-8 string to UTF-16 string
//	Parameters:
//	std::wstring &utf16string - reference to the output UTF-16 string
//	std::string_view utf8string - input UTF-8 string view
//	int byte_count - number of bytes to convert
//	-------------------------------------------------------
...
//	Parameters:
//	wchar_t* utf16cstring - pointer to the output UTF-16 C string
//	int wchar_count - number of wide characters to convert
//	const char* utf8cstring - pointer to the input UTF-8 C string
//	int byte_count - number of bytes to convert
//	-------------------------------------------------------
