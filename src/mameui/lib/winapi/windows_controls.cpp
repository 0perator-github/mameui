...
{
	std::wstring utf16_app_name;
	std::wstring utf16_id_list;

	if (app_name)
		mui_utf16_from_utf8string(utf16_app_name, app_name);

	if (id_list)
		mui_utf16_from_utf8string(utf16_id_list, id_list);

	return set_window_theme(window_handle, app_name ? utf16_app_name.c_str() : nullptr, id_list ? utf16_id_list.c_str() : nullptr);
}
