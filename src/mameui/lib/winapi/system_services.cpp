...
{
	std::string utf8_procedure_name;

	if (procedure_name)
		mui_utf8_from_utf16string(utf8_procedure_name, procedure_name);

	return get_proc_address_utf8(module_handle, (procedure_name) ? utf8_procedure_name.c_str() : nullptr);
}
